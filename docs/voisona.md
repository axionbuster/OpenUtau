...
4. Choose **Refresh voices**, then select **Chis-A (VoiSona Japanese)** or **Chis-A (VoiSona English / Cross-Lingual)** on an OpenUtau track. The default phonemizer passes lyrics to VoiSona, which supplies pronunciation and timing.
